        ...
        (pic->pins[pic->t1cki - 1].value == 1)))) // TMRICS=t1cki  TMREN=1
  {
    ...
    if (pic->cp3 >= fpw2[((*pic->P18map.T3CON) & 0x30) >> 4]) {
      ...
      if ((*pic->P18map.TMR3L) == 0) {
        if (((*pic->P18map.TMR3H) + 1) == 0x100)
          (*pic->P18map.PIR2) |= 0x02; // TMR3IF
        (*pic->P18map.TMR3H)++;
      }
      pic->cp3 = 0;
    }
    ...
    if ((pic->CCPCOUNT >= 1) && (pic->ccp[0].pin > 0) &&
      ...
      if (((*pic->P18map.TMR3H) == (*pic->P18map.CCPR1H)) &&
          ((*pic->P18map.TMR3L) == (*pic->P18map.CCPR1L))) // match !!
      {
    ...
    if ((pic->CCPCOUNT >= 2) && (pic->ccp[1].pin > 0) &&
      ...
      if (((*pic->P18map.TMR3H) == (*pic->P18map.CCPR2H)) &&
          ((*pic->P18map.TMR3L) == (*pic->P18map.CCPR2L))) // match !!
      {
