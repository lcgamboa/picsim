...
void pic_decode_16E(_pic* pic) {
        ...
        case 0x2000:
            switch (opc & 0x0800) {
                case 0x0000:
                    ...
                    pic->stack[0] = pic->pc;
                    pic->jpc =
                        ((pic->ram[bank | (sfr_addr(pic->P16Emap.PCLATH) & 0x007F)] & 0x18) << 8) | (opc & 0x07FF);
                    pic->s2 = 1;
                    break;
                case 0x0800:
        ...
        case 0x3000:
            switch (opc & 0x0F00) {
                ...
                case 0x0B00:
                    ...
                    if (pic->print)
                        printf("SUBWFB %#04X,%d\n", opc & 0x007F, (opc & 0x0080) >> 7);
                    if ((0xF0 & ((0x0F & (~(*pic->P16Emap.WREG))) + (!((*pic->P16Emap.STATUS) & 0x01)) + 1 +
                                 (0x0F & pic->ram[bank | (opc & 0x007F)]))) != 0)
                        *status |= 0x02;
                    else
                        *status &= ~0x02;

                    temp = (~((*pic->P16Emap.WREG) + (!((*pic->P16Emap.STATUS) & 0x01))) + 1) +
                           pic->ram[bank | (opc & 0x007F)];
                ...
                case 0x0D00:
                    ...
                    if ((0xF0 & ((0x0F & (*pic->P16Emap.WREG)) + (0x0F & pic->ram[bank | (opc & 0x007F)]) +
    ...
    if (pic->lram != 0x8000) {
        ...
        if (plram == pic->P16Emap.TOSL) {
            if (((*pic->P16Emap.STKPTR) & 0x1F) > 0)
                pic->stack[((*pic->P16Emap.STKPTR) & 0x1F) - 1] =
                    (pic->stack[((*pic->P16Emap.STKPTR) & 0x1F) - 1] & 0x1FFF00) | (*pic->P16Emap.TOSL);
        }
        if (plram == pic->P16Emap.TOSH) {
            if (((*pic->P16Emap.STKPTR) & 0x1F) > 0)
                pic->stack[((*pic->P16Emap.STKPTR) & 0x1F) - 1] =
                    (pic->stack[((*pic->P16Emap.STKPTR) & 0x1F) - 1] & 0x1F00FF) | ((*pic->P16Emap.TOSH) << 8);
        }
        ...
        if (plram == pic->P16Emap.LATA) {
            (*pic->P16Emap.PORTA) =
                ((*pic->P16Emap.PORTA) & (*pic->P16Emap.TRISA)) | ((*pic->P16Emap.LATA) & (~(*pic->P16Emap.TRISA)));
        }
        if (plram == pic->P16Emap.LATB) {
            (*pic->P16Emap.PORTB) =
                ((*pic->P16Emap.PORTB) & (*pic->P16Emap.TRISB)) | ((*pic->P16Emap.LATB) & (~(*pic->P16Emap.TRISB)));
        }
        if (plram == pic->P16Emap.LATC) {
            (*pic->P16Emap.PORTC) =
                ((*pic->P16Emap.PORTC) & (*pic->P16Emap.TRISC)) | ((*pic->P16Emap.LATC) & (~(*pic->P16Emap.TRISC)));
        }
        if (plram == pic->P16Emap.LATD) {
            (*pic->P16Emap.PORTD) =
                ((*pic->P16Emap.PORTD) & (*pic->P16Emap.TRISD)) | ((*pic->P16Emap.LATD) & (~(*pic->P16Emap.TRISD)));
        }
        if (plram == pic->P16Emap.LATE) {
            (*pic->P16Emap.PORTE) =
                ((*pic->P16Emap.PORTE) & (*pic->P16Emap.TRISE)) | ((*pic->P16Emap.LATE) & (~(*pic->P16Emap.TRISE)));
        }
