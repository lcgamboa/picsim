...
PIC16F1788_reset(void)
{
 ...
 pic->pins[ 7].port = P_VSS    ;pic->pins[ 7].pord = -1;
 pic->pins[ 8].port = pic->P16Emap.PORTA;pic->pins[ 8].pord = 7;
 pic->pins[ 9].port = pic->P16Emap.PORTA;pic->pins[ 9].pord = 6;
 pic->pins[10].port = pic->P16Emap.PORTC;pic->pins[10].pord = 0;
 pic->pins[11].port = pic->P16Emap.PORTC;pic->pins[11].pord = 1;
 pic->pins[12].port = pic->P16Emap.PORTC;pic->pins[12].pord = 2;
 pic->pins[13].port = pic->P16Emap.PORTC;pic->pins[13].pord = 3;
 pic->pins[14].port = pic->P16Emap.PORTC;pic->pins[14].pord = 4;
 pic->pins[15].port = pic->P16Emap.PORTC;pic->pins[15].pord = 5;
 pic->pins[16].port = pic->P16Emap.PORTC;pic->pins[16].pord = 6;
 pic->pins[17].port = pic->P16Emap.PORTC;pic->pins[17].pord = 7;
 pic->pins[18].port = P_VSS    ;pic->pins[18].pord = -1;
 pic->pins[19].port = P_VDD    ;pic->pins[19].pord = -1;pic->pins[19].value = 1;
 pic->pins[20].port = pic->P16Emap.PORTB;pic->pins[20].pord = 0;
 pic->pins[21].port = pic->P16Emap.PORTB;pic->pins[21].pord = 1;
 pic->pins[22].port = pic->P16Emap.PORTB;pic->pins[22].pord = 2;
 pic->pins[23].port = pic->P16Emap.PORTB;pic->pins[23].pord = 3;
 pic->pins[24].port = pic->P16Emap.PORTB;pic->pins[24].pord = 4;
...
int
PIC16F1788_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
