...
void
PIC18F67J94_reset(void)
{
 pic->pins[ 0].port = pic->P18map.PORTE;pic->pins[ 0].pord = 1;
 pic->pins[ 1].port = pic->P18map.PORTE;pic->pins[ 1].pord = 0;
 pic->pins[ 2].port = pic->P18map.PORTG;pic->pins[ 2].pord = 0;
 pic->pins[ 3].port = pic->P18map.PORTG;pic->pins[ 3].pord = 1;
 pic->pins[ 4].port = pic->P18map.PORTG;pic->pins[ 4].pord = 2;
 pic->pins[ 5].port = pic->P18map.PORTG;pic->pins[ 5].pord = 3; 
 pic->pins[ 6].port = P_RST    ;pic->pins[ 6].pord = -1;
 pic->pins[ 7].port = pic->P18map.PORTG;pic->pins[ 7].pord = 4;
 pic->pins[ 8].port = P_VSS    ;pic->pins[ 8].pord = -1;
//pic->pins[ 9].port =  vddcore 
 pic->pins[10].port = pic->P18map.PORTF;pic->pins[10].pord = 7;
 pic->pins[11].port = pic->P18map.PORTF;pic->pins[11].pord = 6;
 pic->pins[12].port = pic->P18map.PORTF;pic->pins[12].pord = 5;
 pic->pins[13].port = pic->P18map.PORTF;pic->pins[13].pord = 4;
 pic->pins[14].port = pic->P18map.PORTF;pic->pins[14].pord = 3;
 pic->pins[15].port = pic->P18map.PORTF;pic->pins[15].pord = 2;
 pic->pins[16].port = P_USB    ;pic->pins[16].pord = -1;
//pic->pins[17].port =vbat 
//pic->pins[18].port = cvref+ 
//pic->pins[19].port = cvref- 
 pic->pins[20].port = pic->P18map.PORTA;pic->pins[20].pord = 3;
 pic->pins[21].port = pic->P18map.PORTA;pic->pins[21].pord = 2;
 pic->pins[22].port = pic->P18map.PORTA;pic->pins[22].pord = 1;
 pic->pins[23].port = pic->P18map.PORTA;pic->pins[23].pord = 0;
//pic->pins[24].port = vsel1 
 pic->pins[25].port = P_VDD    ;pic->pins[25].pord = -1;pic->pins[25].value = 1;
 pic->pins[26].port = pic->P18map.PORTA;pic->pins[26].pord = 5;
 pic->pins[27].port = pic->P18map.PORTA;pic->pins[27].pord = 4;
 pic->pins[28].port = pic->P18map.PORTC;pic->pins[28].pord = 1;
 pic->pins[29].port = pic->P18map.PORTC;pic->pins[29].pord = 0;
 pic->pins[30].port = pic->P18map.PORTC;pic->pins[30].pord = 6;
 pic->pins[31].port = pic->P18map.PORTC;pic->pins[31].pord = 7;
 pic->pins[32].port = pic->P18map.PORTC;pic->pins[32].pord = 2;
 pic->pins[33].port = pic->P18map.PORTC;pic->pins[33].pord = 3;
 pic->pins[34].port = pic->P18map.PORTC;pic->pins[34].pord = 4;
 pic->pins[35].port = pic->P18map.PORTC;pic->pins[35].pord = 5;
 pic->pins[36].port = pic->P18map.PORTB;pic->pins[36].pord = 7;
 pic->pins[37].port = P_VDD    ;pic->pins[37].pord = -1;pic->pins[37].value = 1;
 pic->pins[38].port = pic->P18map.PORTA;pic->pins[38].pord = 7;
 pic->pins[39].port = pic->P18map.PORTA;pic->pins[39].pord = 6;
//pic->pins[40].port = vsel3b 
 pic->pins[41].port = pic->P18map.PORTB;pic->pins[41].pord = 6;
 pic->pins[42].port = pic->P18map.PORTB;pic->pins[42].pord = 5;
 pic->pins[43].port = pic->P18map.PORTB;pic->pins[43].pord = 4;
 pic->pins[44].port = pic->P18map.PORTB;pic->pins[44].pord = 3;
 pic->pins[45].port = pic->P18map.PORTB;pic->pins[45].pord = 2;
 pic->pins[46].port = pic->P18map.PORTB;pic->pins[46].pord = 1;
 pic->pins[47].port = pic->P18map.PORTB;pic->pins[47].pord = 0;
 pic->pins[48].port = pic->P18map.PORTD;pic->pins[48].pord = 7;
 pic->pins[49].port = pic->P18map.PORTD;pic->pins[49].pord = 6;
 pic->pins[50].port = pic->P18map.PORTD;pic->pins[50].pord = 5;
 pic->pins[51].port = pic->P18map.PORTD;pic->pins[51].pord = 4;
 pic->pins[52].port = pic->P18map.PORTD;pic->pins[52].pord = 3;
 pic->pins[53].port = pic->P18map.PORTD;pic->pins[53].pord = 2;
 pic->pins[54].port = pic->P18map.PORTD;pic->pins[54].pord = 1;
 pic->pins[55].port = P_VSS    ;pic->pins[55].pord = -1;
//pic->pins[56].port = vsel0 
 pic->pins[57].port = pic->P18map.PORTD;pic->pins[57].pord = 0;
 pic->pins[58].port = pic->P18map.PORTE;pic->pins[58].pord = 7;
 pic->pins[59].port = pic->P18map.PORTE;pic->pins[59].pord = 6;
 pic->pins[60].port = pic->P18map.PORTE;pic->pins[60].pord = 5;
 pic->pins[61].port = pic->P18map.PORTE;pic->pins[61].pord = 4;
 pic->pins[62].port = pic->P18map.PORTE;pic->pins[62].pord = 3;
 pic->pins[63].port = pic->P18map.PORTE;pic->pins[63].pord = 2;
...
int
PIC18F67J94_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
