...
PIC16F1939_reset(void)
{
 ...
 pic->pins[ 3].port = pic->P16Emap.PORTA;pic->pins[ 3].pord = 2;
 pic->pins[ 4].port = pic->P16Emap.PORTA;pic->pins[ 4].pord = 3;
 pic->pins[ 5].port = pic->P16Emap.PORTA;pic->pins[ 5].pord = 4;
 pic->pins[ 6].port = pic->P16Emap.PORTA;pic->pins[ 6].pord = 5;
 pic->pins[ 7].port = pic->P16Emap.PORTE;pic->pins[ 7].pord = 0;
 pic->pins[ 8].port = pic->P16Emap.PORTE;pic->pins[ 8].pord = 1;
 pic->pins[ 9].port = pic->P16Emap.PORTE;pic->pins[ 9].pord = 2;
 pic->pins[10].port = P_VDD    ;pic->pins[10].pord = -1;pic->pins[10].value = 1;
 pic->pins[11].port = P_VSS    ;pic->pins[11].pord = -1;
 pic->pins[12].port = pic->P16Emap.PORTA;pic->pins[12].pord = 7;
 pic->pins[13].port = pic->P16Emap.PORTA;pic->pins[13].pord = 6;
 pic->pins[14].port = pic->P16Emap.PORTC;pic->pins[14].pord = 0;
 pic->pins[15].port = pic->P16Emap.PORTC;pic->pins[15].pord = 1;
 pic->pins[16].port = pic->P16Emap.PORTC;pic->pins[16].pord = 2;
 pic->pins[17].port = pic->P16Emap.PORTC;pic->pins[17].pord = 3;
 pic->pins[18].port = pic->P16Emap.PORTD;pic->pins[18].pord = 0;
 pic->pins[19].port = pic->P16Emap.PORTD;pic->pins[19].pord = 1;
 pic->pins[20].port = pic->P16Emap.PORTD;pic->pins[20].pord = 2;
 pic->pins[21].port = pic->P16Emap.PORTD;pic->pins[21].pord = 3;
 pic->pins[22].port = pic->P16Emap.PORTC;pic->pins[22].pord = 4;
 pic->pins[23].port = pic->P16Emap.PORTC;pic->pins[23].pord = 5;
 pic->pins[24].port = pic->P16Emap.PORTC;pic->pins[24].pord = 6;
 pic->pins[25].port = pic->P16Emap.PORTC;pic->pins[25].pord = 7;
 pic->pins[26].port = pic->P16Emap.PORTD;pic->pins[26].pord = 4;
 pic->pins[27].port = pic->P16Emap.PORTD;pic->pins[27].pord = 5;
 pic->pins[28].port = pic->P16Emap.PORTD;pic->pins[28].pord = 6;
 pic->pins[29].port = pic->P16Emap.PORTD;pic->pins[29].pord = 7;
 pic->pins[30].port = P_VSS    ;pic->pins[30].pord = -1;
 pic->pins[31].port = P_VDD    ;pic->pins[31].pord = -1;pic->pins[31].value = 1;
 pic->pins[32].port = pic->P16Emap.PORTB;pic->pins[32].pord = 0;
 pic->pins[33].port = pic->P16Emap.PORTB;pic->pins[33].pord = 1;
 pic->pins[34].port = pic->P16Emap.PORTB;pic->pins[34].pord = 2;
 pic->pins[35].port = pic->P16Emap.PORTB;pic->pins[35].pord = 3;
 pic->pins[36].port = pic->P16Emap.PORTB;pic->pins[36].pord = 4;
 pic->pins[37].port = pic->P16Emap.PORTB;pic->pins[37].pord = 5;
 pic->pins[38].port = pic->P16Emap.PORTB;pic->pins[38].pord = 6;
 pic->pins[39].port = pic->P16Emap.PORTB;pic->pins[39].pord = 7;
...
int
PIC16F1939_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
