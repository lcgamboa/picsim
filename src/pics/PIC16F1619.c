...
void
PIC16F1619_reset(void)
{
 
 pic->pins[ 0].port = P_VDD    ;pic->pins[ 0].pord = -1;pic->pins[ 0].value = 1;
 pic->pins[ 1].port = pic->P16Emap.PORTA;pic->pins[ 1].pord = 5;
 pic->pins[ 2].port = pic->P16Emap.PORTA;pic->pins[ 2].pord = 4;
 pic->pins[ 3].port = pic->P16Emap.PORTA;pic->pins[ 3].pord = 3;
 pic->pins[ 4].port = pic->P16Emap.PORTC;pic->pins[ 4].pord = 5;
 pic->pins[ 5].port = pic->P16Emap.PORTC;pic->pins[ 5].pord = 4;
 pic->pins[ 6].port = pic->P16Emap.PORTC;pic->pins[ 6].pord = 3;
 pic->pins[ 7].port = pic->P16Emap.PORTC;pic->pins[ 7].pord = 6;
 pic->pins[ 8].port = pic->P16Emap.PORTC;pic->pins[ 8].pord = 7;
 pic->pins[ 9].port = pic->P16Emap.PORTB;pic->pins[ 9].pord = 7;
 pic->pins[10].port = pic->P16Emap.PORTB;pic->pins[10].pord = 6;
 pic->pins[11].port = pic->P16Emap.PORTB;pic->pins[11].pord = 5;
 pic->pins[12].port = pic->P16Emap.PORTB;pic->pins[12].pord = 4;
 pic->pins[13].port = pic->P16Emap.PORTC;pic->pins[13].pord = 2;
 pic->pins[14].port = pic->P16Emap.PORTC;pic->pins[14].pord = 1;
 pic->pins[15].port = pic->P16Emap.PORTC;pic->pins[15].pord = 0;
 pic->pins[16].port = pic->P16Emap.PORTA;pic->pins[16].pord = 2;
 pic->pins[17].port = pic->P16Emap.PORTA;pic->pins[17].pord = 1;
 pic->pins[18].port = pic->P16Emap.PORTA;pic->pins[18].pord = 0;
...
int
PIC16F1619_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
...
void
PIC16F1619_stop(void)
{
 p16e_uart_stop (0);
}

void
PIC16F1619_start(void)
{
 pic->ROMSIZE = 8192;
 pic->EEPROMSIZE = 0;
 pic->RAMSIZE = 4096;
