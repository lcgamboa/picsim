...
01 - RA2 AN2 C12IN2- C12IN+ Vref- DACOUT
02 - RA3 AN3 C12IN3- C1IN+ Vref+ C1OUT CCP3 SRQ
03 - RA4 AN4 C2OUT T0CKI CCP4 SRNQ
04 - RA5 MCLR Vpp SS1
05 - Vss
06 - RB0 T1G CCP1 P1A INT SRI FLT0
07 - RB1 AN11 RX DT SDA1 SDI1
08 - RB2 AN10 MDMIN TX CK RX DT SDA2 SDI2 SDO1
09 - RB3 AN9 MDOUT CCP1 P1A
10 - RB4 AN8 SCL1 SCK1 MDCIN2
11 - RB5 AN7 P1B TX CK SCL2 SCK2 SS1
12 - RB6 AN5 T1CKI T1OSI P1C CCP2 P2A ICSPCLK ICDCLK
13 - RB7 AN6 T1OSO P1D P2B MDCIN1 ICSPDAT ICDDAT
14 - Vdd
15 - RA6 OSC2 CLKOUT CLKR P1D P2B SDO1
16 - RA7 OSC1 CLKIN P1C CCP2 P2A
17 - RA0 AN0 C12IN0- SDO2
18 - RA1 AN1 C12IN1- SS2
 */
...
void PIC16F1847_reset(_pic* pic) {
...
void PIC16F1847_periferic(_pic* pic) {
    p16e_mssp(pic);
    p16e_adc(pic);
    p16e_int_pin(pic);
    // p16e_int_portb(pic);
...
int PIC16F1847_getconf(_pic* pic, unsigned int cfg) {
    switch (cfg) {
        case CFG_MCLR:
...
void PIC16F1847_disable_debug(_pic* pic) {
    pic->config[1] |= 0x0100;
}

void PIC16F1847_stop(_pic* pic) {
    p16e_uart_stop(pic, 0);
}

void PIC16F1847_start(_pic* pic) {
    pic->ROMSIZE = 8192;
    pic->EEPROMSIZE = 256;
    pic->RAMSIZE = 4096;
    pic->PINCOUNT = 18;
    ...
    pic->USARTCOUNT = 1;
    pic->WDT_MS = 1;
    pic->reset = PIC16F1847_reset;
    pic->mmap = PIC16F1847_map;
    pic->getconf = PIC16F1847_getconf;
    pic->periferic = PIC16F1847_periferic;
    pic->interrupt = interrupt16E;
    pic->stop = PIC16F1847_stop;
    pic->disable_debug = PIC16F1847_disable_debug;

    p16e_uart_start(pic, 0);
}

init_pic(PIC16F1847, P16E, 0x1480);
