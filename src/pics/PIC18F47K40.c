...
void PIC18F47K40_map(_pic* pic) {
    ...
    pic->P18map.SSP2CLKPPS = &pic->ram[0xE8F];
    pic->P18map.SSP2DATPPS = &pic->ram[0xE90];
    pic->P18map.SSP2SSPPS = &pic->ram[0xE91];
    pic->P18map.SSP2BUF = &pic->ram[0xE92];
    pic->P18map.SSP2ADD = &pic->ram[0xE93];
    pic->P18map.SSP2MSK = &pic->ram[0xE94];
    pic->P18map.SSP2STAT = &pic->ram[0xE95];
    ...
    pic->P18map.INT1PPS = &pic->ram[0xEA2];
    pic->P18map.INT2PPS = &pic->ram[0xEA3];
    pic->P18map.T0CKIPPS = &pic->ram[0xEA4];
    pic->P18map.T1CKIPPS = &pic->ram[0xEA5];
    pic->P18map.T1GPPS = &pic->ram[0xEA6];
    pic->P18map.T3CKIPPS = &pic->ram[0xEA7];
    pic->P18map.T3GPPS = &pic->ram[0xEA8];
    pic->P18map.T5CKIPPS = &pic->ram[0xEA9];
    pic->P18map.T5GPPS = &pic->ram[0xEAA];
    pic->P18map.T2INPPS = &pic->ram[0xEAB];
    pic->P18map.T4INPPS = &pic->ram[0xEAC];
    pic->P18map.T6INPPS = &pic->ram[0xEAD];
    pic->P18map.ADACTPPS = &pic->ram[0xEAE];
    pic->P18map.CCP1PPS = &pic->ram[0xEAF];
    pic->P18map.CCP2PPS = &pic->ram[0xEB0];
    pic->P18map.CWG1PPS = &pic->ram[0xEB1];
    pic->P18map.MDCARLPPS = &pic->ram[0xEB2];
    pic->P18map.MDCARHPPS = &pic->ram[0xEB3];
    pic->P18map.MDSRCPPS = &pic->ram[0xEB4];
    pic->P18map.RX1PPS = &pic->ram[0xEB5];
    pic->P18map.CK1PPS = &pic->ram[0xEB6];
    ...
    */
    ...
    pic->P18map.WDTTMR = &pic->ram[0xED6];
    pic->P18map.CPUDOZE = &pic->ram[0xED7];
    pic->P18map.OSCCON1 = &pic->ram[0xED8];
    pic->P18map.OSCCON2 = &pic->ram[0xED9];
    pic->P18map.OSCCON3 = &pic->ram[0xEDA];
    pic->P18map.OSCSTAT = &pic->ram[0xEDB];
    pic->P18map.OSCEN = &pic->ram[0xEDC];
    pic->P18map.OSCTUNE = &pic->ram[0xEDD];
    pic->P18map.OSCFRQ = &pic->ram[0xEDE];
    pic->P18map.VREGCON = &pic->ram[0xEDF];
    pic->P18map.BORCON = &pic->ram[0xEE0];
    pic->P18map.PMD0 = &pic->ram[0xEE1];
    pic->P18map.PMD1 = &pic->ram[0xEE2];
    pic->P18map.PMD2 = &pic->ram[0xEE3];
    ...
    pic->P18map.RA3PPS = &pic->ram[0xEEA];
    pic->P18map.RA4PPS = &pic->ram[0xEEB];
    pic->P18map.RA5PPS = &pic->ram[0xEEC];
    pic->P18map.RA6PPS = &pic->ram[0xEED];
    pic->P18map.RA7PPS = &pic->ram[0xEEE];
    pic->P18map.RB0PPS = &pic->ram[0xEEF];
    pic->P18map.RB1PPS = &pic->ram[0xEF0];
    pic->P18map.RB2PPS = &pic->ram[0xEF1];
    pic->P18map.RB3PPS = &pic->ram[0xEF2];
    pic->P18map.RB4PPS = &pic->ram[0xEF3];
    pic->P18map.RB5PPS = &pic->ram[0xEF4];
    pic->P18map.RB6PPS = &pic->ram[0xEF5];
    pic->P18map.RB7PPS = &pic->ram[0xEF6];
    pic->P18map.RC0PPS = &pic->ram[0xEF7];
    pic->P18map.RC1PPS = &pic->ram[0xEF8];
    pic->P18map.RC2PPS = &pic->ram[0xEF9];
    pic->P18map.RC3PPS = &pic->ram[0xEFA];
    pic->P18map.RC4PPS = &pic->ram[0xEFB];
    ...
    pic->P18map.INLVLA = &pic->ram[0xF0D];
    ...
    pic->P18map.INLVLC = &pic->ram[0xF1D];
    ...
    */
    ...
    /*
     ...
     pic->P18map.ZCDCON = &pic->ram[0xF32];
     pic->P18map.DAC1CON0 = &pic->ram[0xF33];
     pic->P18map.DAC1CON1 = &pic->ram[0xF34];
     pic->P18map.CM2CON0 = &pic->ram[0xF35];
     pic->P18map.CM2CON1 = &pic->ram[0xF36];
     pic->P18map.CM2NCH = &pic->ram[0xF37];
     pic->P18map.CM2PCH = &pic->ram[0xF38];
     pic->P18map.CM1CON0 = &pic->ram[0xF39];
     pic->P18map.CM1CON1 = &pic->ram[0xF3A];
     pic->P18map.CM1NCH = &pic->ram[0xF3B];
     pic->P18map.CM1PCH = &pic->ram[0xF3C];
     pic->P18map.CMOUT = &pic->ram[0xF3D];
     pic->P18map.CLKRCON = &pic->ram[0xF3E];
     pic->P18map.CLKRCLK = &pic->ram[0xF3F];
     pic->P18map.CWG1CLK = &pic->ram[0xF40];
     pic->P18map.CWG1ISM = &pic->ram[0xF41];
     pic->P18map.CWG1DBR = &pic->ram[0xF42];
     pic->P18map.CWG1DBF = &pic->ram[0xF43];
     pic->P18map.CWG1CON0 = &pic->ram[0xF44];
     pic->P18map.CWG1CON1 = &pic->ram[0xF45];
     pic->P18map.CWG1AS0 = &pic->ram[0xF46];
     pic->P18map.CWG1AS1 = &pic->ram[0xF47];
     pic->P18map.CWG1STR = &pic->ram[0xF48];
     pic->P18map.SCANLADRL = &pic->ram[0xF49];
     pic->P18map.SCANLADRH = &pic->ram[0xF4A];
     pic->P18map.SCANLADRU = &pic->ram[0xF4B];
     pic->P18map.SCANHADRL = &pic->ram[0xF4C];
     pic->P18map.SCANHADRH = &pic->ram[0xF4D];
     pic->P18map.SCANHADRU = &pic->ram[0xF4E];
     pic->P18map.SCANCON0 = &pic->ram[0xF4F];
     pic->P18map.SCANTRIG = &pic->ram[0xF50];
     pic->P18map.MDCON0 = &pic->ram[0xF51];
     pic->P18map.MDCON1 = &pic->ram[0xF52];
     pic->P18map.MDSRC = &pic->ram[0xF53];
     pic->P18map.MDCARL = &pic->ram[0xF54];
     pic->P18map.MDCARH = &pic->ram[0xF55];
     pic->P18map.ADACT = &pic->ram[0xF56];
     pic->P18map.ADCLK = &pic->ram[0xF57];
     pic->P18map.ADREF = &pic->ram[0xF58];
      */
    ...
    */
    ...
    pic->P18map.ADRESL = &pic->ram[0xF63];
    pic->P18map.ADRESH = &pic->ram[0xF64];
    /*
    pic->P18map.ADSTAT = &pic->ram[0xF65];
    pic->P18map.ADRPT = &pic->ram[0xF66];
    pic->P18map.ADCNT = &pic->ram[0xF67];
    pic->P18map.ADSTPTL = &pic->ram[0xF68];
    pic->P18map.ADSTPTH = &pic->ram[0xF69];
    pic->P18map.ADLTHL = &pic->ram[0xF6A];
    pic->P18map.ADLTHH = &pic->ram[0xF6B];
    pic->P18map.ADUTHL = &pic->ram[0xF6C];
    pic->P18map.ADUTHH = &pic->ram[0xF6D];
    pic->P18map.ADERRL = &pic->ram[0xF6E];
    pic->P18map.ADERRH = &pic->ram[0xF6F];
    pic->P18map.ADACCL = &pic->ram[0xF70];
    pic->P18map.ADACCH = &pic->ram[0xF71];
    pic->P18map.ADFLTRL = &pic->ram[0xF72];
    pic->P18map.ADFLTRH = &pic->ram[0xF73];
    pic->P18map.CRCDATL = &pic->ram[0xF74];
    pic->P18map.CRCDATH = &pic->ram[0xF75];
    pic->P18map.CRCACCL = &pic->ram[0xF76];
    pic->P18map.CRCACCH = &pic->ram[0xF77];
    pic->P18map.CRCSHIFTL = &pic->ram[0xF78];
    pic->P18map.CRCSHIFTH = &pic->ram[0xF79];
    pic->P18map.CRCXORL = &pic->ram[0xF7A];
   ...
   pic->P18map.SSP1CON3 = &pic->ram[0xF98];
    ...
    pic->P18map.PWM4CON = &pic->ram[0xFA2];
    pic->P18map.PWM3DCL = &pic->ram[0xFA3];
    pic->P18map.PWM3DCH = &pic->ram[0xFA4];
    pic->P18map.PWM3CON = &pic->ram[0xFA5];
     */
    pic->P18map.CCPR2L = &pic->ram[0xFA6];
    pic->P18map.CCPR2H = &pic->ram[0xFA7];
    pic->P18map.CCP2CON = &pic->ram[0xFA8];
    // pic->P18map.CCP2CAP = &pic->ram[0xFA9];
    pic->P18map.CCPR1L = &pic->ram[0xFAA];
    pic->P18map.CCPR1H = &pic->ram[0xFAB];
    pic->P18map.CCP1CON = &pic->ram[0xFAC];
    /*
    pic->P18map.CCP1CAP = &pic->ram[0xFAD];
    pic->P18map.CCPTMRS = &pic->ram[0xFAE];
    pic->P18map.T6TMR = &pic->ram[0xFAF];
    pic->P18map.T6PR = &pic->ram[0xFB0];
    pic->P18map.T6CON = &pic->ram[0xFB1];
    pic->P18map.T6HLT = &pic->ram[0xFB2];
    pic->P18map.T6CLKCON = &pic->ram[0xFB3];
    pic->P18map.T6RST = &pic->ram[0xFB4];
    pic->P18map.T4TMR = &pic->ram[0xFB5];
    pic->P18map.T4PR = &pic->ram[0xFB6];
    pic->P18map.T4CON = &pic->ram[0xFB7];
    ...
    */
    ...
    pic->P18map.T2RST = &pic->ram[0xFC0];
    pic->P18map.TMR5L = &pic->ram[0xFC1];
    pic->P18map.TMR5H = &pic->ram[0xFC2];
    pic->P18map.T5CON = &pic->ram[0xFC3];
    pic->P18map.T5GCON = &pic->ram[0xFC4];
    pic->P18map.T5GATE = &pic->ram[0xFC5];
    pic->P18map.T5CLK = &pic->ram[0xFC6];
     */
    pic->P18map.TMR3L = &pic->ram[0xFC7];
    pic->P18map.TMR3H = &pic->ram[0xFC8];
    pic->P18map.T3CON = &pic->ram[0xFC9];
    /*
    pic->P18map.T3GCON = &pic->ram[0xFCA];
    pic->P18map.T3GATE = &pic->ram[0xFCB];
    pic->P18map.T3CLK = &pic->ram[0xFCC];
     */
    pic->P18map.TMR1L = &pic->ram[0xFCD];
    pic->P18map.TMR1H = &pic->ram[0xFCE];
    pic->P18map.T1CON = &pic->ram[0xFCF];
    /*
...
void PIC18F47K40_reset(_pic* pic) {
    ...
    p18_uart_rst_3(pic, 1);
}

void PIC18F47K40_periferic(_pic* pic) {
    p18_pps_out(pic);
    p18_mssp_2(pic);
    p18_adc_3(pic);
    p18_int_pin_2(pic);
...
int PIC18F47K40_getconf(_pic* pic, unsigned int cfg) {
    switch (cfg) {
        case CFG_MCLR:
...
void PIC18F47K40_disable_debug(_pic* pic) {
    pic->config[1] |= 0x2000;
}

void PIC18F47K40_stop(_pic* pic) {
    p18_uart_stop(pic, 0);
    p18_uart_stop(pic, 1);
}
...
void PIC18F47K40_start(_pic* pic) {
    ...
    pic->stop = PIC18F47K40_stop;
    pic->disable_debug = PIC18F47K40_disable_debug;
