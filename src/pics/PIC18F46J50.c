...
void
PIC18F46J50_reset(void)
{
 pic->pins[ 0].port = pic->P18map.PORTC;pic->pins[ 0].pord = 7;
 pic->pins[ 1].port = pic->P18map.PORTD;pic->pins[ 1].pord = 4;
 pic->pins[ 2].port = pic->P18map.PORTD;pic->pins[ 2].pord = 5;
 pic->pins[ 3].port = pic->P18map.PORTD;pic->pins[ 3].pord = 6;
 pic->pins[ 4].port = pic->P18map.PORTD;pic->pins[ 4].pord = 7;
 pic->pins[ 5].port = P_VSS    ;pic->pins[ 5].pord = -1;
 pic->pins[ 6].port = P_VDD    ;pic->pins[ 6].pord = -1;pic->pins[ 6].value = 1;
 pic->pins[ 7].port = pic->P18map.PORTB;pic->pins[ 7].pord = 0;
 pic->pins[ 8].port = pic->P18map.PORTB;pic->pins[ 8].pord = 1;
 pic->pins[ 9].port = pic->P18map.PORTB;pic->pins[ 9].pord = 2;
 pic->pins[10].port = pic->P18map.PORTB;pic->pins[10].pord = 3;
 pic->pins[11].port = P_NC    ;pic->pins[11].pord = -1;
 pic->pins[12].port = P_NC    ;pic->pins[12].pord = -1;
 pic->pins[13].port = pic->P18map.PORTB;pic->pins[13].pord = 4;
 pic->pins[14].port = pic->P18map.PORTB;pic->pins[14].pord = 5;
 pic->pins[15].port = pic->P18map.PORTB;pic->pins[15].pord = 6;
 pic->pins[16].port = pic->P18map.PORTB;pic->pins[16].pord = 7;
 pic->pins[17].port = P_RST    ;pic->pins[17].pord = -1;
 pic->pins[18].port = pic->P18map.PORTA;pic->pins[18].pord = 0;
 pic->pins[19].port = pic->P18map.PORTA;pic->pins[19].pord = 1;
 pic->pins[20].port = pic->P18map.PORTA;pic->pins[20].pord = 2;
 pic->pins[21].port = pic->P18map.PORTA;pic->pins[21].pord = 3;
 pic->pins[22].port = P_VDD    ;pic->pins[22].pord = -1;pic->pins[22].value = 1;//vddcore
 pic->pins[23].port = pic->P18map.PORTA;pic->pins[23].pord = 5;
 pic->pins[24].port = pic->P18map.PORTE;pic->pins[24].pord = 0;
 pic->pins[25].port = pic->P18map.PORTE;pic->pins[25].pord = 1;
 pic->pins[26].port = pic->P18map.PORTE;pic->pins[26].pord = 2;
 pic->pins[27].port = P_VDD    ;pic->pins[27].pord = -1;pic->pins[27].value = 1;
 pic->pins[28].port = P_VSS    ;pic->pins[28].pord = -1;
 pic->pins[29].port = pic->P18map.PORTA;pic->pins[29].pord = 7;
 pic->pins[30].port = pic->P18map.PORTA;pic->pins[30].pord = 6;
 pic->pins[31].port = pic->P18map.PORTC;pic->pins[31].pord = 0;
 pic->pins[32].port = P_NC    ;pic->pins[32].pord = -1;
 pic->pins[33].port = P_NC    ;pic->pins[33].pord = -1;
 pic->pins[34].port = pic->P18map.PORTC;pic->pins[34].pord = 1;
 pic->pins[35].port = pic->P18map.PORTC;pic->pins[35].pord = 2;
 pic->pins[36].port = P_USB    ;pic->pins[36].pord = -1;
 pic->pins[37].port = pic->P18map.PORTD;pic->pins[37].pord = 0;
 pic->pins[38].port = pic->P18map.PORTD;pic->pins[38].pord = 1;
 pic->pins[39].port = pic->P18map.PORTD;pic->pins[39].pord = 2;
 pic->pins[40].port = pic->P18map.PORTD;pic->pins[40].pord = 3;
 pic->pins[41].port = pic->P18map.PORTC;pic->pins[41].pord = 4;
 pic->pins[42].port = pic->P18map.PORTC;pic->pins[42].pord = 5;
 pic->pins[43].port = pic->P18map.PORTC;pic->pins[43].pord = 6;
...
int
PIC18F46J50_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
