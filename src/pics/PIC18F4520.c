...
#endif
 pic->P18map.WS = &pic->ram[0xF86];
 pic->P18map.STATUSS = &pic->ram[0xF87];
 pic->P18map.BSRS = &pic->ram[0xF88];
...
int
PIC18F4520_getconf(unsigned int cfg)
{
 switch (cfg)
  {
  case CFG_MCLR:
