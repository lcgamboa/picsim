...
void periferic16E_step_out(_pic* pic) {
    ...
    if (((*pic->P16Emap.PORTA) != pic->porta) || ((pic->P16Emap.PORTB) && ((*pic->P16Emap.PORTB) != pic->portb)) ||
        ((pic->P16Emap.PORTC) && ((*pic->P16Emap.PORTC) != pic->portc)) ||
            ...
            if (pic->pins[i].pord >= 0)
                switch (pic->pins[i].dir) {
                    ...
                    case PD_IN:
                        ...
                        port =
                            sfr_addr(pic->pins[i].port) + (sfr_addr(pic->P16Emap.LATA) - sfr_addr(pic->P16Emap.PORTA));
    ...
    if (((*pic->P16Emap.TRISA) != pic->trisa) || ((pic->P16Emap.TRISB) && ((*pic->P16Emap.TRISB) != pic->trisb)) ||
        ((pic->P16Emap.TRISC) && ((*pic->P16Emap.TRISC) != pic->trisc)) ||
