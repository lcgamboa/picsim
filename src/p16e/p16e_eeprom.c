     ...
     if (((*pic->P16Emap.EECON1) & 0x01) == 0x01) //RD
      {
       if (((*pic->P16Emap.EECON1) & 0x80) == 0)
        ...
        {
         (*pic->P16Emap.EEDATL) = (pic->prog[((*pic->P16Emap.EEADRH) << 8) | (*pic->P16Emap.EEADRL)])&0x00FF;
         (*pic->P16Emap.EEDATH) = ((pic->prog[((*pic->P16Emap.EEADRH) << 8) | (*pic->P16Emap.EEADRL)])&0xFF00) >> 8;
       ...
       if (pic->ee_wr == 1)
        {
         if (((*pic->P16Emap.EECON1) & 0x80) == 0)
          ...
          {
           pic->prog[((*pic->P16Emap.EEADRH) << 8) | (*pic->P16Emap.EEADRL)] = ((*pic->P16Emap.EEDATH) << 8) | (*pic->P16Emap.EEDATL);
