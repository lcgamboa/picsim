     ...
     if ((*pic->P16Emap.TMR2) == (*pic->P16Emap.PR2))
      {
       ...
       if ((pic->CCPCOUNT >= 1)&&(pic->ccp[0].pin > 0)&&((*pic->P16Emap.CCP1CON)& 0x0C) == 0x0C)
        {
       ...
       if ((pic->CCPCOUNT >= 2)&&(pic->ccp[1].pin > 0)&&((*pic->P16Emap.CCP2CON)& 0x0C) == 0x0C)
        {
       ...
       /*         
                if((pic->CCPCOUNT >= 3)&&(pic->ccp[2].pin > 0)&&((*pic->P16Emap.CCP3CON)& 0x0C) == 0x0C)
                {
                  pic->ram[P16E_CCPR3H]=pic->ram[P16E_CCPR3L];
                  if(pic->pins[pic->ccp[2].pin-1].dir == PD_OUT)
                    pic->ram[pic->pins[(pic->ccp[2].pin-1)].port]|=0x01<<(pic->pins[(pic->ccp[2].pin-1)].pord);
                } 
        */
      }
     pic->cp2 = 0;
