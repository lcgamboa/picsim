...
void main_loop(void) {
  ...
  //  printf("pc=%#06X w=%#04X 0x00=%#04X 0x04=%#04X 0x05=%#04X 0x06=%#04X
  //  status=%#04X
  ...
  do {
    ...
    if (fst) {
      ...
      case P16E:
        printf("PC=0x%04X W=\033[1;32m 0x%#02X \033[0m STATUS=0x%02X "
               "PORTA=0x%02X PORTB=0x%02X INTCON=\033[1;32m 0x%02X \033[0m "
               "TMR0=0x%02X TMR1H=0x%04X TMR1L=0x%04X OPTION=0x%04X\n",
               pic1.pc, pic1.w, (*pic1.P16Emap.STATUS), (*pic1.P16Emap.PORTA),
               (*pic1.P16Emap.PORTB), (*pic1.P16Emap.INTCON),
               (*pic1.P16Emap.TMR0), (*pic1.P16Emap.TMR1H),
               (*pic1.P16Emap.TMR1L), (*pic1.P16Emap.OPTION_REG));

        printf(
            "BSR=0x%02X INDF0=0x%02X INDF1=0x%02X afsr0=0x%04X afsr1=0x%04X\n",
        ...
        break;
      case P18:
        printf("PC    =0x%04X W=\033[1;32m 0x%02X \033[0m  STKPTR=0x%02X "
               "TOS=0x%06X PORTB=0x%02X PORTE=0x%02X status=\033[1;32m 0x%02X "
               "\033[0m INTCON=0x%02X afsr0=0x%04X afsr1=0x%04X afsr2=0x%04X\n",
               pic1.pc, pic1.w, (*pic1.P18map.STKPTR),
               (*pic1.P18map.STKPTR) << 16 | (*pic1.P18map.TOSH) << 8 |
                   (*pic1.P18map.TOSL),
               (*pic1.P18map.PORTB), (*pic1.P18map.PORTE),
               (*pic1.P18map.STATUS), (*pic1.P18map.INTCON),
        ...
        printf("INTCON=0x%02X   PIE1=0x%02X PIR1=0x%02X   TMR1=0x%04X  "
               "CCP1=0x%04X\n",
               (*pic1.P18map.INTCON), (*pic1.P18map.PIE1), (*pic1.P18map.PIR1),
        ...
        printf("FSR0=%#04X  POSTINC0=%#04X\n",
               ((*pic1.P18map.FSR0H) << 8) + (*pic1.P18map.FSR0L),
               (*pic1.P18map.POSTINC0));
        /*
                      printf("0x550: ");
                      for(i=0;i<16;i++)
    ...
    //  for(i=0;i<18;i++)
    //    printf("%02i %i %i %i\n",i,pic_get_pin_dir(&pic1,i+1),
    //    pic_get_pin(&pic1,i+1), pic_get_pin_type(&pic1,i+1));
